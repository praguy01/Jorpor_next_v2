...
import CompNavbarTec from '../compNavbar/row_3';
          ...
          if (data.success === true) {
            ...
            for (const percentage of data.percent){
              ...
              if (percentage.currentDateA === formattedDate) {
                // console.log("datatoday: ",percentage)
              ...
              <ResponsiveContainer width="100%" height={300}>
                ...
                <LineChart
                  ...
                  // style={{ backgroundColor: '#fff', borderRadius: '20px' }}
                   data={data}  margin={{ top: 30, right: 30, left: 20, bottom: 5 }} radius={[20]} className=' bg-[#fff] rounded-[20px] text-[10px]'
                >
