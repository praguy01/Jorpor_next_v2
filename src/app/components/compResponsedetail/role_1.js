        ...
        <div className='md:w-[1000px] mx-auto '>
          ...
          {console.log("TODOOO: ",todoList)}
              ...
              <div className='px-2 flex items-center mx-auto w-[250px]  md:ml-[40px] md:w-[720px]  py-[20px] text-black bg-[#F5F5F5] text-center mt-[15px] rounded-[20px]'>
                <div className=' text-[12px] md:text-[18px]  rounded-[10px] w-[235px] md:w-[700px] border py-2 md:py-4 bg-[#F5F5F5] ml-[5px] md:ml-[40px]'>
                    ...
                    <div className='flex px-3  mt-[5px]'>
                      ...
                      <div className='flex px-3  mt-[5px]'>
                        ...
                        <p>:</p>
                        <p className='md:ml-[15px] ml-[10px] w-[120px] whitespace-nowrap border overflow-ellipsis overflow-hidden md:w-[450px] text-left'>{todo.work_owner}</p>
                    </div>
