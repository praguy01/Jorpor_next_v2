      ...
      <div className='md:w-[800px] lg:w-[1000px] mx-auto '>
          ...
          {console.log("TODOOO: ",todoList)}
              ...
              <div className=' px-2 flex items-center mx-auto w-[250px]  md:ml-[40px] md:w-[670px] lg:w-[720px]  py-[20px] text-black bg-[#F5F5F5] text-center mt-[15px] rounded-[20px]'>
                ...
                <p className="text-[#808080] text-[13px] md:text-[16px] md:mt-[20px] ml-[-170px] md:ml-[-540px] lg:ml-[-580px] mt-[10px]">{t("Uploaded images")}</p>
             ...
             {fileData && (
                <div className="border mt-[20px] border-grey-800 p-2 w-[235px] ">
                  ...
                  <div>
                    <p className=' text-[#808080] text-[13px] md:text-[16px] ml-[-170px] md:ml-[-610px] lg:ml-[-670px] mt-[20px]  md:mt-[16px]'>{t('details')}</p>
                    <textarea
                      type="text"
                      name="detail"
