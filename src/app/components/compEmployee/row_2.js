      ...
      <CompNavbar/>
        ...
        <div className=' bg-[url("/bg1.png")]  bg-cover bg-no-repeat absolute z-[-1] top-0 left-0 w-full h-full bg-center overflow-auto  '>
          <div className='md:w-[1000px] mx-auto '>
            ...
            <div className='mx-auto justify-between flex w-[330px] md:w-[800px] font-ntr text-black   mt-[106px]  '>
                  <h1 className={`text-[25px] text-black md:text-[30px] ml-[10px]   ${language === 'EN' ? ' font-ntr' : ' font-mitr font-small'  } font-bold `}>  {`${language === 'EN' ? 'Employee List' : ' รายชื่อพนักงาน'  }`}</h1>
                  <button
                  onClick={openPopup} 
                  className="  text-[#5A985E] text-ri text-4xl md:text-5xl  hover:-translate-y-0.5 duration-200 ">
                  <BsPlusCircleFill/>
                </button>
              </div>
                <div className='flex md:mt-[50px]   md:ml-[430px]'>
                    ...
                    {showPopup && (
                     <div className="text-center absolute z-10  top-0 left-0 w-full h-full flex items-center justify-center">
                      <div className="bg-white  p-4 py-[40px] rounded-lg border border-grey shadow-lg">
                     {/* <div className="bg-[#D9D9D9] border w-[90px] rounded-[25px]"> */}
                      ...
                      {/* </div> */}
                       <h2 className={`text-[30px] text-[#5A985E]  ${language === 'EN' ? ' font-ntr' : ' font-mitr font-small'  } font-bold`}>{`${language === 'EN' ? 'Add employee list' : 'เพิ่มรายชื่อ'  }`}</h2>
                       {/* {isOn && (   */}
            ...
            {/* <div className=' w-[330px] md:w-[800px] items-center text-right mx-auto '> */}
            {/* <div className='  items-center mx-auto w-[330px] md:w-[780px] '>
              ...
              {/* <div className='mt-[20px] border w-[20px] '> */}
            ...
            <div className='mx-auto w-[330px] md:w-[800px] h-[400px]  text-black flex flex-col border bg-[#FFF]  rounded-b-[20px] md:rounded-b-[20px]   overflow-auto'>
