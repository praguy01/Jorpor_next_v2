  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const AddData = { responseValue , responseDetail : true};
        ...
        if (response.status === 200) {
          if (data.success === true) {
            ...
            console.log("fileData: ", data.responseResult[0].file);
            ...
            setTodoList([...todoList, notifyData[indexValue]]);
              ...
              <div className='font-ntr px-2 flex items-center mx-auto w-[250px]  md:ml-[40px] md:w-[720px]  py-[20px] text-black bg-[#F5F5F5] text-center mt-[15px] rounded-[20px]'>
                <div className='  font-ntr text-sm md:text-[18px]  rounded-[10px] w-[235px] md:w-[600px] py-2 md:py-4 bg-[#F5F5F5] ml-[5px] md:ml-[40px]'>
                    ...
                    <div className='flex px-3 '>
                        ...
                        <p>:</p>
                        <p className='md:ml-[15px] ml-[10px]'>{todo.employee}</p>
                    </div>
                    ...
                    <div className='flex px-3  mt-[5px]'>
                      ...
                      <p>:</p>    
                      <p className='md:ml-[15px] ml-[10px]'>{todo.location}</p>
                    </div>
                 
                      <div className='flex px-3  mt-[5px]'>
                        <p className='text-[#000] text-left  w-[75px]  ml-[-1px] md:w-[100px] md:ml-[-11px]'>Work Owner </p>
                        <p>:</p>
                        <p className='md:ml-[15px] ml-[10px]'>{todo.work_owner}</p>
                    </div>
                      ...
                      <div className='flex px-3 mt-[5px]'>
                        ...
                        <p>:</p>
                        <p className='md:ml-[15px] text-left md:w-[350px] w-[120px] ml-[10px]'>{todo.status}</p>
                    </div>
                      ...
                      <div className='flex px-3  mt-[5px]'>
                        ...
                        <p>:</p>
                        <p className='md:ml-[15px] ml-[10px]'>{formatDateTime(todo.date) }</p>
                    </div>
