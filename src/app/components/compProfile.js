...
function App() {
  ...
  const handleSaveClick = async () => {
    try {
      ...
      const editedData = { ...editedProfileData, edit: true };
                 ...
                 <PiPencilSimpleFill onClick={handleEditClick} className = 'absolute text-[#fff] md:text-[20px] md:ml-[640px]  mt-[-10px] ml-[260px] cursor-pointer'/>
                  ...
                  <div className={` md:flex md:absolute mx-auto  ${isEditing ? 'mt-[0px] ' : 'mt-[30px] ' } md:w-[200px] md:h-[150px] `}>
                    ...
                    <>
                      ...
                      />
                      <img
                        src={selectedImage || profileData.img || "/img/profile.jpg"}
                        alt="Profile Image"
                        className="ring-2 ring-white ring-offset-2 ring-offset-[#5A985E] w-32 h-32  mx-auto md:w-[150px] md:h-[150px] rounded-full object-cover cursor-pointer"
                      />
                      </>
                    ) : (
                      <img
