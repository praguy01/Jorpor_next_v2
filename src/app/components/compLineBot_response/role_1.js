    ...
    <button
      ...
      <div className=' bg-[url("/bg1.png")] overflow-auto bg-cover bg-no-repeat absolute z-[-1] top-0 left-0 w-full h-full bg-center   '>
        <div className='md:w-[800px] lg:w-[1000px] mx-auto '>
          ...
          <div className="mx-auto border w-full max-w-[330px] md:max-w-[700px] lg:max-w-[800px] py-[20px] min-h-[60vh] text-black flex flex-col rounded-[30px] mt-[25px] bg-[#fff]">
            ...
            <div className='mx-auto w-[290px] md:w-[650px] lg:w-[750px]  py-[20px] md:h-[900px] h-[680px] text-black flex flex-col  bg-[#D9D9D9] md:rounded-[30px] rounded-[30px] mt-[20px] overflow-auto '>
              {todoList.length === 0 && (
